...
PitLore currently has one maintainer. A report involving that maintainer does
not yet have an independent project-level escalation path; this limitation will
be revised when a second trusted maintainer joins.
